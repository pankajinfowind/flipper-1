...
@Component({
  selector: 'app-best-seller-reports',
  templateUrl: './best-seller-reports.component.html',
  styleUrls: ['./best-seller-reports.component.scss']
})
export class BestSellerReportsComponent implements OnInit {
  ...
  ngOnInit() {
    this.v.webTitle('View Best Seller Reports');
  ...
  export(){
    return this.v.downloadFile(AppConfig.url+"/secure/user-sales-rpts?export=true&branch_id="+parseInt(localStorage.getItem('active_branch'))+"&from="+this.dataForm.value.from+"&to="+this.dataForm.value.to);
  }
