...
//     // expect(
//     //   Document('testdoc', data: {'foo': 'bar'}).save(),
...
//     expect(doc1.jsonProperties, mutDoc.jsonProperties);

//     mutDoc.properties['foo'] = 'baz';
//     mutDoc.properties['name'].asMap['first'] = 'test0';

//     expect(doc1.jsonProperties, isNot(mutDoc.jsonProperties));
