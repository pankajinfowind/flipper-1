...
export class DashboardComponent implements OnInit {
  ...
  constructor(
    ...
    // FIXME:
    this.branch = null
    this.totalStore = 0.0 //this.getStockValue();
    this.netProfit = 0.0 //this.getNetProfit();
    this.totalRevenue = 0.0 // this.getTotalRevenues();
    this.grossProfits = 0.0 //this.getGrossProfit();
