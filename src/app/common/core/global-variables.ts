...
export class GlobalVariables {
  ...
  public current_path: 'home' | 'bin' | 'settings' | 'folder' | 'projects' | 'starred' | 'my-box' | any = 'my-box';
  ...
  // tslint:disable-next-line:max-line-length
  public archive = ['zip', 'x-rar', 'x-rar-compressed', 'x-7z-compressed', 'x-ace-compressed', 'x-zoo', 'x-gtar', 'x-stuffit', 'x-apple-diskimage',
  ...
  // set currentFocusedFolder(f: YFContract) {
  //   this.current_focused_folder = f;
  // }
  // get currentFocusedFolder(): YFContract {
  //   return this.current_focused_folder;
  // }
  // set folderToUpdate(f: any) {
  //   this.folder_to_update.next(f);
  // }
  // get folderToUpdate(): any {
  //   return this.folder_to_update$;
  // }
  set token(p: string) {
    this._token = p;
  }
