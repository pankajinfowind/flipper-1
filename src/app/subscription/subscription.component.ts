...
export class SubscriptionComponent implements OnInit {
  ...
  confirmPayment(creds, payType) {
    const headers = new HttpHeaders({
      ...
      // TODO:add token back in a user model
    ...
    return this.httpClient
      .post(environment.appUrl + 'api/pay', creds, { headers })
          ...
          if (response.message.status === 'error') {
            ...
            if (payType === 'MOMO') {
              ...
              if (
                ...
                response.message.meta.authorization &&
                response.message.meta.authorization.mode == 'redirect'
              ) {
