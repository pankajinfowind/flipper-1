...
Widget getCardTypeIcon({CardType cardType, String cardNumber}) {
  switch (cardType == null ? getCardType(cardNumber) : cardType) {
    case CardType.americanExpress:
      return Image.asset(
        'assets/card_provider/american_express.png',
        width: 55,
        height: 40,
      );
    case CardType.dinersClub:
      return Image.asset(
        'assets/card_provider/diners_club.png',
        width: 40,
        height: 40,
      );
    case CardType.discover:
      return Image.asset(
        'assets/card_provider/discover.png',
        width: 70,
        height: 50,
      );
    case CardType.jcb:
      return Image.asset(
        'assets/card_provider/jcb.png',
        width: 40,
        height: 40,
      );
    case CardType.masterCard:
      return Image.asset(
        'assets/card_provider/master_card.png',
        width: 55,
        height: 40,
      );
    case CardType.maestro:
      return Image.asset(
        'assets/card_provider/maestro.png',
        width: 55,
        height: 40,
      );
    case CardType.rupay:
      return Image.asset(
        'assets/card_provider/rupay.png',
        width: 80,
        height: 50,
      );
    case CardType.visa:
      return Image.asset(
        'assets/card_provider/visa.png',
        width: 55,
        height: 40,
      );
    default:
