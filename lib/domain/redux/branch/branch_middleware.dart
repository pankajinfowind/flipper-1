...
List<Middleware<AppState>> createBranchMiddleware(
  ...
  return [
    ...
    TypedMiddleware<AppState, OnSetBranchHint>(_onSetBranchHint(navigatorKey)),
  ];
}
...
void Function(Store<AppState> store, dynamic action, NextDispatcher next)
  ...
  return (Store<AppState> store, action, next) async {
    ...
    final List<Map<String, dynamic>> businesses = await _databaseService.filter(
    ...
    final Map<String, dynamic> _mapBranch = {
      ...
      'businessId': Business.fromMap(businesses[0]['main']).id,
      'id': Uuid().v1(),
    ...
    store.dispatch(
        ActiveBusinessAction(Business.fromMap(businesses[0]['main'])));
